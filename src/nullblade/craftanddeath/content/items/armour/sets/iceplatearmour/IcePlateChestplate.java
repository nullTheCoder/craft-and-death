...
public class IcePlateChestplate extends CustomItem implements ArmourItem {

    public IcePlateChestplate() {
        item = new ItemStack(Material.LEATHER_CHESTPLATE);
        id = "ice_plate_torso";
        LeatherArmorMeta meta = (LeatherArmorMeta) item.getItemMeta();
        meta.setColor(Color.fromRGB(100, 150, 255));
        meta.setDisplayName("§fice plate torso");
        ...
        r.shape(new String[]{"p p", "ppp", "ppp"});
